...
export function InvoicePreview({ data }: InvoicePreviewProps) {
  ...
  return (
    <div className="invoice-a4 font-body text-[10px] leading-tight text-gray-900 flex flex-col min-h-[297mm] bg-white relative overflow-hidden" id="print-area">
      ...
      <div className="relative z-10 flex flex-col flex-grow">
        ...
        <div className="px-0.5 flex-grow">
          <table className="w-full text-[10px] border-collapse table-fixed bg-transparent">
            <thead>
              <tr className="border-y-[1px] border-gray-900 bg-transparent text-[10px]">
                <th className="p-0.5 text-left w-[6.5%] font-normal">P Id</th>
                <th className="p-0.5 text-left w-[20%] font-normal">Description</th>
                <th className="p-0.5 text-center w-[8%] font-normal">Pack Size</th>
                <th className="p-0.5 text-center w-[7%] font-normal">Unit TP</th>
                <th className="p-0.5 text-center w-[6%] font-normal">VAT Rate%</th>
                <th className="p-0.5 text-center w-[6.5%] font-normal">Unit VAT</th>
                <th className="p-0.5 text-center w-[6.5%] font-normal">Unit Dis</th>
                <th className="p-0.5 text-center w-[5%] font-normal">QTY</th>
                <th className="p-0.5 text-center w-[5%] font-normal">Bonus</th>
                <th className="p-0.5 text-center w-[8%] font-normal">Total TP</th>
                <th className="p-0.5 text-center w-[8%] font-normal">Total VAT</th>
                <th className="p-0.5 text-center w-[6%] font-normal">Spec. Dis</th>
                <th className="p-0.5 text-right w-[10.5%] font-normal">Total Price</th>
              </tr>
            </thead>
            <tbody className="bg-transparent">
              {data.productLines.map((line, idx) => {
                ...
                return (
                  <tr key={idx} className="border-b border-gray-200 align-top bg-transparent text-[10px]">
                    <td className="p-1">{line.productId}</td>
                    <td className="p-1 leading-tight font-normal">{line.description}</td>
                    ...
                    <td className="p-1 text-right font-normal text-black">{formatCurrency(totalPrice)}</td>
                  </tr>
                );
              })}
            </tbody>
            <tfoot className="bg-transparent">
              <tr className="bg-transparent text-[10px]">
                <td colSpan={9} className="p-1 text-right border-t-[1.5px] border-gray-900 pr-10">
                  <span className="font-normal uppercase inline-block whitespace-nowrap">TOTAL AMOUNT :</span>
                </td>
                <td className="p-1 text-center font-normal text-gray-900 border-t-[1.5px] border-gray-900">{formatCurrency(totals.totalTp)}</td>
                <td className="p-1 text-center font-normal text-gray-900 border-t-[1.5px] border-gray-900">{formatCurrency(totals.totalVat)}</td>
                <td className="p-1 text-center font-normal text-gray-900 border-t-[1.5px] border-gray-900">{formatCurrency(totals.specialDis)}</td>
                <td className="p-1 text-right text-[10px] font-normal text-gray-900 border-t-[1.5px] border-gray-900">{formatCurrency(totals.totalPrice)}</td>
              </tr>
            </tfoot>
          </table>
          ...
          <div className="mt-2 px-1">
            <div className="flex justify-between items-start">
              <div className="space-y-1">
                <p className="text-[10px] font-normal uppercase">Note :</p>
                <p className="text-[10px] font-normal uppercase tracking-tight text-gray-900">FIFTY BRAND OFFER, PAYMENT OPTION: CASH/CHEQUE</p>
              </div>
              <div className="w-72">
                <div className="flex justify-between border-t border-gray-400 py-1 text-[10px]">
                ...
                <div className="flex justify-between pt-0.5 border-t-[1px] border-gray-200">
                  <span className="text-[10px] font-normal">Net Payable Amount</span>
          ...
          <div className="mt-6 px-1">
            <p className="font-normal uppercase text-[10px] text-black leading-tight">
              IN WORD: {numberToWords(totals.totalPrice)}
            </p>
          </div>

          <div className="mt-4 px-1 text-left">
            <p className="text-[10px] font-normal border-b-[0.5px] border-black text-black inline-block leading-tight">
        ...
        <div className="mt-auto px-1 pb-6">
          <div className="flex justify-between items-end mb-8 pt-16">
            <div className="grid grid-cols-6 gap-6 flex-1 text-[10px] font-normal text-gray-900">
